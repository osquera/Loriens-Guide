...
class TestAPI(unittest.TestCase):
    ...
    def test_find_nearest_camera_success(self) -> None:
        """Test finding nearest camera with valid coordinates."""
        payload = {"lat": 55.6761, "long": 12.5683}

        response = self.client.post(
            "/api/v1/cameras/nearest", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_find_nearest_camera_missing_fields(self) -> None:
    ...
    def test_find_nearest_camera_invalid_data(self) -> None:
        """Test finding nearest camera with invalid data types."""
        payload = {"lat": "invalid", "long": 12.5683}
    ...
    def test_query_missing_fields(self) -> None:
        ...
        response = self.client.post("/api/v1/query", data=json.dumps(payload), content_type="application/json")
    ...
    def test_query_invalid_json(self) -> None:
        ...
        response = self.client.post("/api/v1/query", data="invalid json", content_type="application/json")

        self.assertEqual(response.status_code, 400)

    def test_query_not_json(self) -> None:
        """Test query endpoint with non-JSON content type."""
        response = self.client.post("/api/v1/query", data="some data", content_type="text/plain")
